...
class DesktopUITests(unittest.TestCase):
    def test_selection_authoring_and_results(self):
        with sync_playwright() as pw:
            ...
            expect(page.get_by_text('Step 2: verify_text — passed')).to_be_visible()
            ...
            expect(page.get_by_role('button', name='Run desktop test')).to_be_disabled()
            expect(page.get_by_role('checkbox', name='I authorize these actions in the selected test window.')).not_to_be_checked()
            ...
            expect(page.get_by_text('Test saved on this computer.')).to_be_visible()
            page.reload()
            expect(page.get_by_label('Test name')).to_have_value('Renamed Notepad test')
            ...
            page.reload()
            expect(page.get_by_label('Include Renamed Notepad test in suite')).to_be_checked()
            ...
            expect(page.get_by_label('Suite name', exact=True)).to_have_value('Independent checks')
